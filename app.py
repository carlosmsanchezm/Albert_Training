    ...
    if body["state"] == "get_balance":
        ...
        if "_SOURCE_ACCOUNT_" in body["slots"]:
            ...
            if body["slots"]["_SOURCE_ACCOUNT_"]["values"][0]["tokens"] == "checking":
                ...
                body["slots"]["_SOURCE_ACCOUNT_"]["values"][0]["tokens"]["balance"] == accounts
                body["slots"]["_SOURCE_ACCOUNT_"]["values"][0]["tokens"]["balance"] == body["slots"]["_SOURCE_ACCOUNT_"]["values"][0]["tokens"]
